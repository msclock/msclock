...
- [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) ([v1.5.3](https://github.com/serious-scaffold/ss-cpp/releases/tag/v1.5.3), 1 day ago) - A continuously evolving basic template for cpp development practice.
- [msclock/cmake-registry](https://github.com/msclock/cmake-registry) ([v1.0.105](https://github.com/msclock/cmake-registry/releases/tag/v1.0.105), 2 days ago) - A cmake modules registry based on vcpkg
- [msclock/cmake-modules](https://github.com/msclock/cmake-modules) ([v1.5.7](https://github.com/msclock/cmake-modules/releases/tag/v1.5.7), 2 days ago) - Some useful cmake module collection
- [onuratakan/gpt-computer-assistant](https://github.com/onuratakan/gpt-computer-assistant) ([v0.21.1](https://github.com/onuratakan/gpt-computer-assistant/releases/tag/v0.21.1), 3 days ago) - gpt-4o for windows, macos and linux
- [serious-scaffold/ss-python](https://github.com/serious-scaffold/ss-python) ([v0.0.54](https://github.com/serious-scaffold/ss-python/releases/tag/v0.0.54), 3 days ago) - An evolving Python project template that covers the full development lifecycle.
...
- [fix: remove redundant trailing comma](https://github.com/serious-scaffold/ss-cpp/pull/322) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (1 day ago)
- [perf: detect git information with git_wt_info](https://github.com/serious-scaffold/ss-cpp/pull/321) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (2 days ago)
- [perf: add git_AnyUncommittedChanges to default template](https://github.com/msclock/cmake-modules/pull/116) on [msclock/cmake-modules](https://github.com/msclock/cmake-modules) (2 days ago)
- [feat: support mkdocs integrating with mkdocs-material](https://github.com/serious-scaffold/ss-cpp/pull/320) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (3 days ago)
...
- [Alvin9999/new-pac](https://github.com/Alvin9999/new-pac) - 翻墙-科学上网、自由上网、免费科学上网、免费翻墙、油管youtube、fanqiang、VPN、一键翻墙浏览器，vps一键搭建翻墙服务器脚本/教程，免费shadowsocks/ss/ssr/v2ray/goflyway账号/节点，翻墙梯子，电脑、手机、iOS、安卓、windows、Mac、Linux、路由器翻墙、科学上网 (4 days ago)
