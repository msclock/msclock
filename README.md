...
- [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) ([v0.0.18](https://github.com/msclock/sphinx-deployment/releases/tag/v0.0.18), 4 days ago) - A versioned doument deployment tool based on sphinx.
...
- [docs: fix git api reference](https://github.com/msclock/sphinx-deployment/pull/54) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (4 days ago)
