...
- [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) ([v0.0.3](https://github.com/msclock/sphinx-deployment/releases/tag/v0.0.3), 2 days ago) - A versioned doument deployment tool based on sphinx.
- [msclock/cmake-registry](https://github.com/msclock/cmake-registry) ([v1.0.24](https://github.com/msclock/cmake-registry/releases/tag/v1.0.24), 3 days ago) - A cmake modules registry based on vcpkg
...
- [docs: refine CONTRIBUTING.md](https://github.com/msclock/pyauthorizer/pull/16) on [msclock/pyauthorizer](https://github.com/msclock/pyauthorizer) (1 day ago)
- [docs: refine CONTRIBUTING.md](https://github.com/msclock/sphinx-deployment/pull/9) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (1 day ago)
- [ci: configure git for pages deployment](https://github.com/msclock/sphinx-deployment/pull/8) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (2 days ago)
