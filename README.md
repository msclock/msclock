...
- [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) ([v0.0.3](https://github.com/msclock/sphinx-deployment/releases/tag/v0.0.3), 5 days ago) - A versioned doument deployment tool based on sphinx.
- [msclock/cmake-registry](https://github.com/msclock/cmake-registry) ([v1.0.24](https://github.com/msclock/cmake-registry/releases/tag/v1.0.24), 6 days ago) - A cmake modules registry based on vcpkg
...
- [ci: configure git for pages deployment](https://github.com/msclock/sphinx-deployment/pull/8) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (5 days ago)
...
- [shlin168/go-nvd](https://github.com/shlin168/go-nvd) - Tools to dump CVE/CPE data from NVD to database, and run API server on top of that (3 days ago)
- [mattiasgustavsson/libs](https://github.com/mattiasgustavsson/libs) - Single-file public domain libraries for C/C&#43;&#43; (6 days ago)
