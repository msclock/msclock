...
- [msclock/smooth7zip](https://github.com/msclock/smooth7zip) - [WIP] A wrapper for 7zip. (2 days ago)
...
- [msclock/cmake-registry](https://github.com/msclock/cmake-registry) ([v1.0.82](https://github.com/msclock/cmake-registry/releases/tag/v1.0.82), 2 days ago) - A cmake modules registry based on vcpkg
- [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) ([v1.4.38](https://github.com/serious-scaffold/ss-cpp/releases/tag/v1.4.38), 2 days ago) - A continuously evolving basic template for cpp development practice.
- [msclock/pyauthorizer](https://github.com/msclock/pyauthorizer) ([v0.2.13](https://github.com/msclock/pyauthorizer/releases/tag/v0.2.13), 3 days ago) - A simple authorizer for python project.
...
- [perf: autoupdate renovate group](https://github.com/serious-scaffold/ss-cpp/pull/229) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (2 days ago)
- [perf: llvm path from macos brew](https://github.com/serious-scaffold/ss-cpp/pull/227) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (2 days ago)
- [perf: action submodule update from renovate](https://github.com/serious-scaffold/ss-cpp/pull/226) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (2 days ago)
- [perf: simplify renovate job](https://github.com/serious-scaffold/ss-cpp/pull/225) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (2 days ago)
- [docs: refine Renovate configuration](https://github.com/serious-scaffold/ss-cpp/pull/223) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (3 days ago)
- [chore: bump vcpkg 1.3.5](https://github.com/msclock/features/pull/22) on [msclock/features](https://github.com/msclock/features) (3 days ago)
- [fix: VCPKG_FORCE_SYSTEM_BINARIES does not work](https://github.com/msclock/features/pull/21) on [msclock/features](https://github.com/msclock/features) (3 days ago)
- [fix: vcpkg install dependencies on specific archs](https://github.com/msclock/features/pull/20) on [msclock/features](https://github.com/msclock/features) (3 days ago)
- [chore: bump vcpkg to 1.3.3](https://github.com/msclock/features/pull/19) on [msclock/features](https://github.com/msclock/features) (5 days ago)
- [chore: bump gcl version 0.0.7](https://github.com/msclock/features/pull/18) on [msclock/features](https://github.com/msclock/features) (5 days ago)

#### ⭐ Recent Stars

- [ip7z/7zip](https://github.com/ip7z/7zip) - 7-Zip (2 days ago)
