...
- [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) ([v1.6.22](https://github.com/serious-scaffold/ss-cpp/releases/tag/v1.6.22), 3 days ago) - A continuously evolving basic template for cpp development practice.
- [Upsonic/Upsonic](https://github.com/Upsonic/Upsonic) ([v0.50.5](https://github.com/Upsonic/Upsonic/releases/tag/v0.50.5), 3 days ago) - The most reliable AI agent framework that supports MCP.
- [serious-scaffold/ss-cmake](https://github.com/serious-scaffold/ss-cmake) ([v0.0.16](https://github.com/serious-scaffold/ss-cmake/releases/tag/v0.0.16), 3 days ago) - The shared serious scaffold template to integrate cmake system.
...
- [perf: update ss-cmake to v0.0.16 from v0.0.13](https://github.com/serious-scaffold/ss-cpp/pull/483) on [serious-scaffold/ss-cpp](https://github.com/serious-scaffold/ss-cpp) (3 days ago)
- [perf: Handle multi-config generators and set build type accordingly](https://github.com/serious-scaffold/ss-cmake/pull/43) on [serious-scaffold/ss-cmake](https://github.com/serious-scaffold/ss-cmake) (3 days ago)
...
- [build: safe and cachable build](https://github.com/msclock/pysubconverter/pull/3) on [msclock/pysubconverter](https://github.com/msclock/pysubconverter) (3 weeks ago)
