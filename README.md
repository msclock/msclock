...
- [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) ([v0.0.3](https://github.com/msclock/sphinx-deployment/releases/tag/v0.0.3), 6 days ago) - A versioned doument deployment tool based on sphinx.
...
- [microsoft/vcpkg](https://github.com/microsoft/vcpkg) ([2023.12.12](https://github.com/microsoft/vcpkg/releases/tag/2023.12.12), 3 weeks ago) - C&#43;&#43; Library Manager for Windows, Linux, and MacOS
...
- [perf: template deployment list view](https://github.com/msclock/sphinx-deployment/pull/12) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (1 day ago)
- [chore: configure license in pyproject.toml](https://github.com/msclock/sphinx-deployment/pull/11) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (3 days ago)
- [docs: refine CONTRIBUTING.md](https://github.com/msclock/pyauthorizer/pull/16) on [msclock/pyauthorizer](https://github.com/msclock/pyauthorizer) (5 days ago)
- [docs: refine CONTRIBUTING.md](https://github.com/msclock/sphinx-deployment/pull/9) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (5 days ago)
- [ci: configure git for pages deployment](https://github.com/msclock/sphinx-deployment/pull/8) on [msclock/sphinx-deployment](https://github.com/msclock/sphinx-deployment) (6 days ago)
...
- [docs: refine documentation](https://github.com/msclock/pyauthorizer/pull/10) on [msclock/pyauthorizer](https://github.com/msclock/pyauthorizer) (3 weeks ago)
...
- [shlin168/go-nvd](https://github.com/shlin168/go-nvd) - Tools to dump CVE/CPE data from NVD to database, and run API server on top of that (4 days ago)
